            ...
            <div class="card mb-4 box-shadow pr-2 pl-2">
              ...
              <div class="card-body p-0">
                ...
                <p class="card-text">
                  ...
                  >Apple MacBook Air 13.3英寸笔记本 银色(Core i5 处理器/8GB内存/128GB SSD闪存 MMGF2CH/A)</a>
                </p>
      ...
      <div class="col-md-3 pl-0">
        ...
        <ul id="cart" class="list-group mb-3">
          ...
          <li class="p-0 list-group-item d-flex justify-content-between lh-condensed">
            <h6 class="w-100 d-flex justify-content-between align-items-center mb-0 text-muted p-2">
              购物车
